...
var Endpoint = __webpack_require__(11);

var BaseNode = function (_Node) {
  _inherits(BaseNode, _Node);

  function BaseNode(opts) {
    _classCallCheck(this, BaseNode);

    var _this = _possibleConstructorReturn(this, (BaseNode.__proto__ || Object.getPrototypeOf(BaseNode)).call(this, opts));
  ...
  _createClass(BaseNode, [{
    ...
    value: function draw(obj) {
      var _dom = obj.dom;
      if (!_dom) {
        _dom = $('<div></div>').attr('class', 'node').attr('id', obj.id);
      }
      var node = $(_dom);
      if (obj.top) {
    ...
    value: function addEndpoint(obj, isInited) {
      if (isInited) {
        ...
        // 这部分可能还需要想一下
        var EndpointClass = obj.Class || Endpoint;
        var endpoint = new EndpointClass(_.assign({
          _on: this._on,
          _emit: this._emit,
          _node: this
        }, obj));
    ...
    key: 'rmEndpoint',
    value: function rmEndpoint(pointId) {
      var rmEndpointIndex = _.findIndex(this.endpoints, function (point) {
    ...
    value: function getEndpoint(pointId) {
      return _.find(this.endpoints, function (point) {
    ...
    value: function _addEventLinster() {
      ...
      $(this.dom).on('click', function (e) {
        e.preventDefault();
        e.stopPropagation();
        _this4._emit('system.node.click', {
          node: _this4
        });
        _this4._emit('events', {
          type: 'node:click',
...
var $ = __webpack_require__(1);
var _ = __webpack_require__(0);
var coordinateService = __webpack_require__(12);
  ...
  _createClass(Endpoint, [{
    ...
    value: function updatePos() {
      ...
      if (this._isInitedDom) {
        ...
        // 分情况弄好方向和位置
        var nodeW = $(this._node.dom).outerWidth();
        var nodeH = $(this._node.dom).outerHeight();
        ...
        var _orientation = orientation || [0, -1];
        var _pos = pos || [0.5, 0];
        ...
        if (this._node && !this.root) {
          ...
          // 计算传入的dom距离跟节点
          var nodeDomOffsets = $(this._node.dom).offset();
          var targetDomOffsets = targetDom.offset();
    ...
    key: 'makeSource',
    value: function makeSource() {
      var _this = this;

      $(this.dom).on('mousedown', function (e) {
        e.preventDefault();
        e.stopPropagation();
        _this._emit('InnerEvents', {
...
var CoordinateService = function () {
  ...
  _createClass(CoordinateService, [{
    ...
    key: 'canvas2terminal',
    value: function canvas2terminal(pos, coordinate) {}
  }, {
    key: 'terminal2canvas',
    value: function terminal2canvas(pos, coordinate) {
      if (pos === 'x') {
        var terCenter = this.terOffsetX + this.terWidth / 2;
        return (coordinate - terCenter - this.canOffsetX) / this.scale + this.terWidth / 2;
      } else if (pos === 'y') {
        var _terCenter = this.terOffsetY + this.terHeight / 2;
        return (coordinate - _terCenter - this.canOffsetY) / this.scale + this.terHeight / 2;
      }
    }
  }]);
...
var _ = __webpack_require__(0);
var $ = __webpack_require__(1);
var DrawUtil = __webpack_require__(43);
var ArrowUtil = __webpack_require__(44);
...
var Edge = function () {
  ...
  _createClass(Edge, [{
    ...
    key: 'calcPath',
    value: function calcPath(sourcePoint, targetPoint) {
      if (!sourcePoint) {
        sourcePoint = {
          pos: [this.type === 'endpoint' ? this.sourceEndpoint._posLeft + this.sourceEndpoint._width / 2 : this.sourceNode.left + this.sourceNode.dom.offsetWidth / 2, this.type === 'endpoint' ? this.sourceEndpoint._posTop + this.sourceEndpoint._height / 2 : this.sourceNode.top + this.sourceNode.dom.offsetHeight / 2
      ...
      if (!targetPoint) {
        targetPoint = {
          pos: [this.type === 'endpoint' ? this.targetEndpoint._posLeft + this.targetEndpoint._width / 2 : this.targetNode.left + this.targetNode.dom.offsetWidth / 2, this.type === 'endpoint' ? this.targetEndpoint._posTop + this.targetEndpoint._height / 2 : this.targetNode.top + this.targetNode.dom.offsetHeight / 2
    ...
    value: function redrawLabel() {
      ...
      $(this.labelDom).css('left', centerPoint.x - this.labelDom.offsetWidth / 2).css('top', centerPoint.y - this.labelDom.offsetHeight / 2);
    }
  }, {
    key: 'drawLabel',
    ...
    value: function redrawArrow(path) {
      var point = this.dom.getPointAtLength(this.dom.getTotalLength() * this.arrowPosition);
      var x = point.x;
      var y = point.y;
    ...
    value: function redraw(sourcePoint, targetPoint, options) {
      // 重新计算线条path
      var path = this.calcPath(sourcePoint, targetPoint);
...
var BaseGroup = function (_Group) {
  _inherits(BaseGroup, _Group);

  function BaseGroup(opts) {
    _classCallCheck(this, BaseGroup);

    var _this = _possibleConstructorReturn(this, (BaseGroup.__proto__ || Object.getPrototypeOf(BaseGroup)).call(this, opts));
  ...
  _createClass(BaseGroup, [{
    ...
    value: function draw(obj) {
      var _dom = $(obj.dom);
      if (!_dom) {
        _dom = $('<div></div>').attr('class', 'group').attr('id', obj.id);
      }
      var group = $(_dom);

      var titleDom = $('<div></div>').attr('class', 'title');
    ...
    value: function addNodes() {
      ...
      nodes.forEach(function (item) {
        item._group = _this2;
        $(_this2.dom).append(item.dom);
        _this2.nodes.push(item);
      });
    }
  }, {
    key: 'addNode',
    ...
    value: function removeNodes() {
      ...
      this.nodes.forEach(function (item) {
        var _node = _.find(nodes, function (_node) {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_nest__ = __webpack_require__(68);
/* unused harmony reexport nest */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_set__ = __webpack_require__(69);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_keys__ = __webpack_require__(70);
/* unused harmony reexport keys */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_values__ = __webpack_require__(71);
/* unused harmony reexport values */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_entries__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3_collection__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_timer__ = __webpack_require__(76);
...
var Edge = __webpack_require__(13);
var Endpoint = __webpack_require__(11);
...
var SelectCanvas = __webpack_require__(82);
// 画布和屏幕坐标地换算
var CoordinateService = __webpack_require__(12);

__webpack_require__(83);

var BaseCanvas = function (_Canvas) {
  _inherits(BaseCanvas, _Canvas);

  function BaseCanvas(options) {
    _classCallCheck(this, BaseCanvas);

    var _this = _possibleConstructorReturn(this, (BaseCanvas.__proto__ || Object.getPrototypeOf(BaseCanvas)).call(this, options));
    ...
    _this.css = options.css || {}; // 这部分需要废弃,因为复写了jsplumb这个模块
    _this.theme = {
      edge: {
    ...
    _this.svg = null;
    _this.warpper = null;
    _this.canvasWarpper = null;
    // 加一层warpper方便处理缩放，平移
    _this._genWarpper();
    // 加一层svg画线条
    _this._genSvgWarpper();
    // 加一层canvas方便处理辅助
    _this._genCanvasWarpper();

    // 统一处理画布拖动事件
    _this._dragType = null;
    _this._dragNode = null;
    _this._dragEndpoint = null;
    _this._dragEdge = null;

    // 初始化一些参数
    _this._rootOffsetX = $(_this.root).offset().left;
    _this._rootOffsetY = $(_this.root).offset().top;
    _this._rootWidth = $(_this.root).width();
    _this._rootHeight = $(_this.root).height();
    ...
    _this._coordinateService = new CoordinateService({
      terOffsetX: $(_this.root).offset().left,
      terOffsetY: $(_this.root).offset().top,
      terWidth: $(_this.root).width(),
      terHeight: $(_this.root).height(),
      canOffsetX: _this._moveData[0],
      canOffsetY: _this._moveData[1],
      scale: _this._zoomData
    });

    _this._addEventLinster();
  ...
  _createClass(BaseCanvas, [{
    ...
    value: function getNode(id) {
      return _.find(this.nodes, function (item) {
        return item.id === id;
      });
    }
  }, {
    ...
    value: function getEdge(id) {
      return _.find(this.edges, function (item) {
        return item.id === id;
      });
    }
  }, {
    ...
    value: function getGroup(id) {
      return _.find(this.groups, function (item) {
        return item.id === id;
      });
    }
  }, {
    ...
    value: function addGroup(group) {
      var container = $(this.warpper);
      var GroupClass = group.Class || Group;
      var _groupObj = new GroupClass(_.assign(_.cloneDeep(group), {
    ...
    value: function addNodes(nodes, isNotEventEmit) {
      ...
      var result = nodes.map(function (node) {
        ...
        if (_this3._isExistNode(_nodeObj)) {
          // 后续用新的node代码旧的node
        ...
        var existGroup = _nodeObj.group ? _this3.getGroup(_nodeObj.group) : null;
        if (!!existGroup) {
    ...
    value: function addEdges(links) {
      ...
      var _arrowFragment = document.createDocumentFragment();

      var result = links.map(function (link) {
        var EdgeClass = _this4.theme.edge.Class;

        if (link.type === 'endpoint') {
          var sourceNode = _this4.getNode(link.sourceNode);
          var targetNode = _this4.getNode(link.targetNode);
          var sourceEndpoint = sourceNode.getEndpoint(link.source);
          var targetEndpoint = targetNode.getEndpoint(link.target);

          var sourceGroup = void 0;
          var targetGroup = void 0;
          if (sourceNode.group) {
            sourceGroup = _this4.getGroup(sourceNode.group);
          }
          if (targetNode.group) {
            targetGroup = _this4.getGroup(targetNode.group);
          }
          ...
          var edge = new EdgeClass({
            ...
            id: link.id,
            label: link.label,
            shapeType: link.shapeType || _this4.theme.edge.type,
            orientationLimit: _this4.theme.endpoint.position,
          ...
          var _sourceNode = _this4.getNode(link.source);
          var _targetNode = _this4.getNode(link.target);
          var _sourceGroup = void 0;
          var _targetGroup = void 0;

          if (_sourceNode.group) {
            _sourceGroup = _this4.getGroup(_sourceNode.group);
          }
          if (_targetNode.group) {
            _targetGroup = _this4.getGroup(_targetGroup.group);
          }
          ...
          if (_edge2.arrowDom) {
            _arrowFragment.appendChild(_edge2.arrowDom);
          }

          _this4.edges.push(_edge2);
    ...
    value: function removeNode(nodeId, isNotDelEdge, isNotEventEmit) {
      var index = _.findIndex(this.nodes, function (_node) {
      ...
      // 删除邻近的线条
      var neighborEdges = this.getNeighborEdges(nodeId);
      if (!isNotDelEdge) {
        this.edges = this.edges.filter(function (edge) {
          var _edge = _.find(neighborEdges, function (item) {
      ...
      var _rmNodes = this.nodes.splice(index, 1);
      // 假如在group里面
      if (node.group) {
        var group = this.getGroup(node.group);
        if (group) {
    ...
    key: 'removeNodes',
    value: function removeNodes(nodeIds, isNotDelEdge, isNotEventEmit) {
      var _this6 = this;

      var rmNodes = [];
      var rmEdges = [];
      nodeIds.map(function (id) {
        return _this6.removeNode(id, isNotDelEdge, isNotEventEmit);
    ...
    value: function removeEdge(edgeId) {
      var edgeIndex = _.findIndex(this.edges, function (item) {
    ...
    key: 'removeEdges',
    value: function removeEdges(edgeIds) {
      var _this7 = this;

      return edgeIds.map(function (item) {
        return _this7.removeEdge(item);
      }).filter(function (item) {
        return item;
      });
    }
    ...
    value: function getNeighborEdges(nodeId) {
    ...
    value: function focusNodeWithAnimate(param) {
      ...
      if (_.isFunction(param)) {
        ...
        // 假如传入的是id，则按照默认规则寻找
        node = type === 'node' ? _.find(this.nodes, function (item) {
          return item.id === param;
        }) : _.find(this.groups, function (item) {
          return item.id === param;
        });
      }
      ...
      if (!node) {
        ...
        if (node.group) {
          var group = _.find(this.groups, function (_group) {
      ...
      var targetY = containerH / 2 - top;
      var targetX = containerW / 2 - left;
    ...
    value: function move(position) {
      $(this.warpper).css('left', position[0]).css('top', position[1]);
      this._coordinateService._changeCanvasInfo({
    ...
    key: 'getMovePosition',
    value: function getMovePosition() {
    ...
    key: 'rmFromUnion',
    value: function rmFromUnion(obj) {}
  }, {
    key: '_genSvgWarpper',
    value: function _genSvgWarpper() {
      // 生成svg的warpper
      var svg = $(document.createElementNS('http://www.w3.org/2000/svg', 'svg')).attr('class', 'butterfly-svg').attr('width', '100%').attr('height', '100%').attr('version', '1.1')
      // .css('position', 'absolute')
      .attr('xmlns', 'http://www.w3.org/2000/svg').appendTo(this.warpper);
      return this.svg = svg;
    }
  }, {
    key: '_genWarpper',
    value: function _genWarpper() {
      // 生成warpper
      var warpper = $('<div class="butterfly-warpper"></div>').appendTo(this.root);
      return this.warpper = warpper[0];
    }
  }, {
    key: '_genCanvasWarpper',
    value: function _genCanvasWarpper() {
      // 生成canvas warpper
    ...
    value: function _addEventLinster() {
      ...
      $(window).resize(function () {
        _this11._rootWidth = $(_this11.root).width();
        _this11._rootHeight = $(_this11.root).height();
      });

      $(this.warpper).on('click', function (e) {
        _this11.emit('system.canvas.click');
        _this11.emit('events', {
          type: 'canvas:click'
        });
      });
      ...
      this.on('InnerEvents', function (data) {
        if (data.type === 'node:addEndpoint') {
          _this11._addEndpoint(data.data, data.isInited);
        } else if (data.type === 'node:dragBegin') {
          _this11._dragType = 'node:drag';
          _this11._dragNode = data.data;
        } else if (data.type === 'group:dragBegin') {
          _this11._dragType = 'group:drag';
          _this11._dragNode = data.data;
        } else if (data.type === 'endpoint:linkBegin') {
          _this11._dragType = 'endpoint:drag';
          _this11._dragEndpoint = data.data;
        } else if (data.type === 'multiple:select') {
          var result = _this11._selectMytiplyItem(data.range);
          _this11.emit('system.multiple.select', {
            data: result
          });
          _this11.emit('events', {
          ...
          // 把框选的加到union的数组
          _this11.unionItem = _this11.selectItem;
    ...
    key: '_addEndpoint',
    value: function _addEndpoint(endpoint, isInited) {
      endpoint._init({
    ...
    value: function _attachMouseDownEvent() {
      ...
      var rootOffsetX = this._rootOffsetX;
      var rootOffsetY = this._rootOffsetY;

      var rootWidth = this._rootWidth;
      var rootHeight = this._rootHeight;
      ...
      var mouseDownEvent = function mouseDownEvent(event) {
        ...
        if (!_this12._dragType && _this12.moveable) {
          _this12._dragType = 'canvas:drag';
        }
        var originLeft = $(_this12.warpper).css('left');
        var originTop = $(_this12.warpper).css('top');
        originPos = {
          x: event.clientX - parseInt(originLeft),
          y: event.clientY - parseInt(originTop)
        };
        _this12.emit('system.drag.start', {
          dragType: _this12._dragType
        });
        _this12.emit('events', {
          type: 'drag:start',
          dragType: _this12._dragType
      ...
      var mouseMoveEvent = function mouseMoveEvent(event) {
        ...
        if (_this12._dragType) {
          var canvasX = _this12._coordinateService.terminal2canvas('x', event.clientX);
          var canvasY = _this12._coordinateService.terminal2canvas('y', event.clientY);
          var offsetX = canvasX - originPos.x;
          var offsetY = canvasY - originPos.y;
          if (_this12._dragType === 'canvas:drag') {
            _this12.move([event.clientX - originPos.x, event.clientY - originPos.y]);
          } else if (_this12._dragType === 'node:drag') {
            ...
            if (_this12._dragNode) {
              var moveNodes = [_this12._dragNode];
              var isUnion = _.find(_this12.unionItem.nodes, function (_node) {
                return _node.id === _this12._dragNode.id;
              });
              if (isUnion) {
                moveNodes = _this12.unionItem.nodes;
              }
              $(_this12.svg).css('display', 'none');
              $(_this12.warpper).css('display', 'none');
              moveNodes.forEach(function (node) {
                node.moveTo(node.left + offsetX, node.top + offsetY);
                $(_this12.svg).css('display', 'none');
                _this12.edges.forEach(function (edge) {
              ...
              $(_this12.svg).css('display', 'block');
              $(_this12.warpper).css('display', 'block');
          ...
          } else if (_this12._dragType === 'group:drag') {
            if (originPos.x === 0 && originPos.y === 0) {
              originPos = {
                x: canvasX,
                y: canvasY
          ...
          } else if (_this12._dragType === 'endpoint:drag') {
            var beginX = _this12._dragEndpoint._posLeft + _this12._dragEndpoint._width / 2;
            var beginY = _this12._dragEndpoint._posTop + _this12._dragEndpoint._height / 2;

            var endX = _this12._coordinateService.terminal2canvas('x', event.clientX);
            var endY = _this12._coordinateService.terminal2canvas('y', event.clientY);

            var edge = null;
            if (!_this12._dragEdge) {
              var EdgeClass = _this12.theme.edge.Class;
              edge = _this12._dragEdge = new EdgeClass({
                shapeType: _this12.theme.edge.type,
                orientationLimit: _this12.theme.endpoint.position,
                _on: _this12.on.bind(_this12),
                _emit: _this12.emit.bind(_this12)
              });
              edge._init();
              $(_this12.svg).append(edge.dom);
            } else {
              edge = _this12._dragEdge;
            }
            var _soucePoint = {
              pos: [beginX, beginY]
            };
            ...
            if (edge.labelDom) {
              $(_this12.warpper).append(edge.labelDom);
            }
            if (edge.arrowDom) {
              $(_this12.svg).append(edge.arrowDom);
            }
            edge.redraw(_soucePoint, _targetPoint);
          }
          _this12.emit('system.drag.move', {
            dragType: _this12._dragType,
            pos: [event.clientX, event.clientY],
            dragNode: _this12._dragNode,
            dragEndpoint: _this12._dragEndpoint,
            dragEdge: _this12._dragEdge
          });
          _this12.emit('events', {
            type: 'drag:move',
            dragType: _this12._dragType,
      ...
      var mouseEndEvent = function mouseEndEvent(event) {
        ...
        if (_this12._dragEdge) {
          ...
          // 释放对应画布上的x,y
          var x = _this12._coordinateService.terminal2canvas('x', event.clientX);
          var y = _this12._coordinateService.terminal2canvas('y', event.clientY);

          var _targetEndpoint = null;

          _this12.nodes.forEach(function (_node) {
            if (_node.endpoints) {
              _node.endpoints.forEach(function (_point) {
                var _maxX = _point._posLeft + _point._width + 10;
                var _maxY = _point._posTop + _point._height + 10;
                var _minX = _point._posLeft - 10;
                var _minY = _point._posTop - 10;
          ...
          if (!_targetEndpoint || _targetEndpoint.scope !== _this12._dragEndpoint.scope || _targetEndpoint.type !== 'target') {
            _this12._dragEdge.destroy();
          } else {
            _this12._dragEdge._create({
              id: _this12._dragEndpoint.id + '-' + _targetEndpoint.id,
              sourceNode: _this12.getNode(_this12._dragEndpoint.nodeId),
              sourceEndpoint: _this12._dragEndpoint,
              targetNode: _this12.getNode(_targetEndpoint.nodeId),
              targetEndpoint: _targetEndpoint,
              type: 'endpoint'
            });
            _this12.edges.push(_this12._dragEdge);
            _this12.emit('system.link.connect', {
              link: _this12._dragEdge
            });
            _this12.emit('events', {
              type: 'link:connect',
              link: _this12._dragEdge
        ...
        if (_this12._dragType === 'node:drag' && _this12._dragNode) {

          var sourceGroup = null;

          var _nodeLeft = _this12._dragNode.left;
          var _nodeRight = _this12._dragNode.left + _this12._dragNode.getWidth();
          var _nodeTop = _this12._dragNode.top;
          var _nodeBottom = _this12._dragNode.top + _this12._dragNode.getHeight();

          if (_this12._dragNode.group) {
            var _group = _this12.getGroup(_this12._dragNode.group);
          ...
          for (var i = 0; i < _this12.groups.length; i++) {
            var _group2 = _this12.groups[i];
            ...
            if (_groupLeft2 <= _nodeLeft && _groupRight2 >= _nodeRight && _groupTop2 <= _nodeTop && _groupBottom2 >= _nodeBottom) {
              if (_group2.id !== _this12._dragNode.group) {
                targetGroup = _group2;
                break;
              }
            }
          ...
          var neighborEdges = [];
          if (sourceGroup) {
            var rmItem = _this12.removeNode(_this12._dragNode.id, true, true);
            ...
            _this12.addNode(rmNode, true);
          } else {
            if (targetGroup) {
              var _rmItem = _this12.removeNode(_this12._dragNode.id, true, true);
        ...
        _this12._dragType = null;
        _this12._dragNode = null;
        _this12._dragEndpoint = null;
        _this12._dragEdge = null;
        originPos = {
          x: 0,
          y: 0
        };
    ...
    value: function _selectMytiplyItem(range) {
      ...
      var startY = this._coordinateService.terminal2canvas('y', range[1]);
      var endX = this._coordinateService.terminal2canvas('x', range[2]);
      var endY = this._coordinateService.terminal2canvas('y', range[3]);

      var includeNode = _.includes(this.selecModel, 'node');
      var includeEdge = _.includes(this.selecModel, 'edge');
      var includeEndpoint = _.includes(this.selecModel, 'endpoint');
      // 框选节点
      if (includeNode) {
        this.nodes.forEach(function (item) {
          var nodeLeft = item.left;
          var nodeRight = item.left + $(item.dom).width();
          ...
          if (startX < nodeLeft && endX > nodeRight && startY < nodeTop && endY > nodeBottom) {
            _this13.selectItem.nodes.push(item);
          }
        });
      }
      ...
      if (includeEndpoint) {
        this.nodes.forEach(function (node) {
          node.endpoints.forEach(function (item) {
            ...
            var pointRight = item._posLeft + $(item.dom).width();
            ...
            if (startX < pointLeft && endX > pointRight && startY < pointTop && endY > pointBottom) {
              _this13.selectItem.endpoints.push(item);
            }
          });
        });
      }
        ...
        this.edges.forEach(function (item) {
          if (item.type === 'endpoint') {
            ...
            if (startX < left && endX > right && startY < top && endY > bottom) {
              _this13.selectItem.edges.push(item);
            }
...
var EventEmit = __webpack_require__(23);
...
var Canvas = function () {
  ...
  _createClass(Canvas, [{
    ...
    key: 'getNeighborEdges',
    value: function getNeighborEdges(id) {}
    ...
    key: 'getNeighborNodes',
    value: function getNeighborNodes(id) {}
    ...
    key: 'setSelectMode',
    value: function setSelectMode(flat) {}
    ...
    key: 'focusNodeWithAnimate',
    value: function focusNodeWithAnimate(id) {}
    ...
    key: 'connection',
    value: function connection(conn) {}
  }]);
...
if(false) {
	module.hot.accept("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./baseEndpoint.less", function() {
		var newContent = require("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./baseEndpoint.less");
...
// module
exports.push([module.i, ".butterflie-circle-endpoint {\n  position: absolute;\n  z-index: 100;\n  width: 6px;\n  height: 6px;\n  border: 1px solid #999;\n  border-radius: 50%;\n  background: #fff;\n}\n", ""]);
...
function drawBezier(sourcePoint, targetPoint) {
  ...
  // 起始点
  var result = ['M', targetPoint.pos[0], targetPoint.pos[1]];
  // 两个控制点
...
function drawFlow(sourcePoint, targetPoint, orientationLimit) {
  ...
  var to = targetPoint.orientation;
  // 拿来判断是对面，垂直还是正交
  ...
  var isYGreaterThanStubTimes2 = Math.abs(sy - ty) > stub + stub;
  ...
  var _lineCalculators = {
    ...
    opposite: function opposite(axis, ss, oss, es) {
      ...
      var comparator = axis === 'x' ? isXGreaterThanStubTimes2 : isYGreaterThanStubTimes2;
...
function _drawFlowSegment(segments, offset) {
  var current = null;
  var next = null;
  var cornerRadius = 0; // 拐角角度，按道理可以配置
  var lw = 1; // strokeWidth，线条的粗细
  var _segLength = function _segLength(s) {
  ...
  var _drawArc = function _drawArc(d) {
    ...
    // 计算两点之间的直线的梯度
    var _gradient = function _gradient(p1, p2) {
      if (p2[0] === p1[0]) {
    ...
    var _theta = function _theta(p1, p2) {
      var m = _gradient(p1, p2);
      var t = Math.atan(m);
      var s = _quadrant(p1, p2);
      if (s === 4 || s === 3) {
        t += Math.PI;
      }
      if (t < 0) {
    ...
    var _calcAngle = function _calcAngle(x, y) {
      return _theta([d.cx, d.cy], [x, y]);
    };

    var startAngle = _calcAngle(x1, y1);
    var endAngle = _calcAngle(x2, y2);
  ...
  for (var i = 0; i < segments.length - 1; i++) {
    ...
    if (cornerRadius > 0 && current[4] !== next[4]) {
      var radiusToUse = Math.min(cornerRadius, _segLength(current), _segLength(next));
  ...
  var _calcWithLimit = function _calcWithLimit(rank) {
    if (orientationLimit) {
      var _loop = function _loop(i) {
        var isInLimit = _.some(orientationLimit, function (limit) {
          return limit === rank[i];
        });
        if (isInLimit) {
          return {
...
function calcSlope(opts) {
  var shapeType = _.get(opts, 'shapeType');
  var dom = _.get(opts, 'dom');
  var arrowPosition = _.get(opts, 'arrowPosition', 0.5);
  var path = _.get(opts, 'path');
  var coordinates = path.split(' ');
  var x = 0;
  var y = 0;

  if (shapeType === 'Bezier') {
    var p0 = { x: coordinates[8], y: coordinates[9] };
    var p1 = { x: coordinates[6], y: coordinates[7] };
    var p2 = { x: coordinates[4], y: coordinates[5] };
    var p3 = { x: coordinates[1], y: coordinates[2] };

    arrowPosition = 1 - arrowPosition; // 贝塞尔曲线是反着画的，需要调整
    x = -3 * p0.x * (1 - arrowPosition) * (1 - arrowPosition) + 3 * p1.x * ((1 - arrowPosition) * (1 - arrowPosition) - 2 * arrowPosition * (1 - arrowPosition)) + 3 * p2.x * (2 * arrowPosition - 3 * arrowPosition * arrowPosition) + 3 * p3.x * arrowPosition * arrowPosition;
    y = -3 * p0.y * (1 - arrowPosition) * (1 - arrowPosition) + 3 * p1.y * ((1 - arrowPosition) * (1 - arrowPosition) - 2 * arrowPosition * (1 - arrowPosition)) + 3 * p2.y * (2 * arrowPosition - 3 * arrowPosition * arrowPosition) + 3 * p3.y * arrowPosition * arrowPosition;
  } else if (shapeType === 'Straight') {
    var _p = { x: coordinates[1], y: coordinates[2] };
    var _p2 = { x: coordinates[4], y: coordinates[5] };
...
if(false) {
	module.hot.accept("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./baseEdge.less", function() {
		var newContent = require("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./baseEdge.less");
...
// module
exports.push([module.i, ".butterflies-link {\n  fill: none;\n  stroke: #B9B9B9;\n  stroke-width: 1px;\n}\n.butterflies-label {\n  position: absolute;\n}\n.butterflies-arrow {\n  fill: none;\n  stroke: #B9B9B9;\n  stroke-width: 1px;\n}\n", ""]);
...
if(false) {
	module.hot.accept("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./baseGroup.less", function() {
		var newContent = require("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./baseGroup.less");
...
function forceLayout(param) {
  ...
  var simulation = d3.forceSimulation(nodes).force('charge', function () {
    if (opts.chargeStrength) {
      return d3.forceManyBody().strength(opts.chargeStrength);
    } else {
      return d3.forceManyBody();
    }
  }()).force('center', d3.forceCenter(opts.width / 2, opts.height / 2)).force('link', d3.forceLink(edges).id(function (node) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_center__ = __webpack_require__(52);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_collide__ = __webpack_require__(53);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_link__ = __webpack_require__(67);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_manyBody__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__src_radial__ = __webpack_require__(79);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_simulation__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_x__ = __webpack_require__(80);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_y__ = __webpack_require__(81);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_quadtree__ = __webpack_require__(15);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__constant__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jiggle__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_collection__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__jiggle__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_d3_quadtree__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__simulation__ = __webpack_require__(17);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_dispatch__ = __webpack_require__(75);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__src_timer__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_timeout__ = __webpack_require__(77);
/* unused harmony reexport timeout */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__src_interval__ = __webpack_require__(78);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__timer__ = __webpack_require__(9);
...
var SelectCanvas = function () {
  ...
  _createClass(SelectCanvas, [{
    ...
    key: 'addEventLinster',
    value: function addEventLinster() {
    ...
    value: function drawRect() {
      ...
      this.clearCanvas();
      var startX = Math.min(this.startX, this.endX) - this.canvasLeft;
      var startY = Math.min(this.startY, this.endY) - this.canvasTop;
...
if(false) {
	module.hot.accept("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./baseCanvas.less", function() {
		var newContent = require("!!../../node_modules/_css-loader@0.28.11@css-loader/index.js!../../node_modules/_less-loader@4.1.0@less-loader/dist/cjs.js!./baseCanvas.less");
